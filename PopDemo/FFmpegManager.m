...
- (void)TransferDecode {
    ...
    NSString *input_str = [NSString stringWithFormat:@"resource.bounle/%@",self.inputurl];
    NSString *output_str = [NSString stringWithFormat:@"resource.bounle/%@",self.outputurl];
